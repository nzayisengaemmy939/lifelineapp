...
export default function HomeScreen({ navigation }: any) {
  ...
  return (
    <View className="flex-1 p-6 items-center justify-between bg-gray-100 top-20">
      {currentLocation ? (
        <MapView
          style={styles.map}
      ...
      <Button
        ...
        className={`px-6 py-3 rounded-lg shadow-md text-white font-semibold w-full mb-20`}
      />
